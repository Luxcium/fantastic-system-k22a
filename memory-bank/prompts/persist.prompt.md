...
tools: ['changes', 'extensions', 'fetch', 'githubRepo', 'openSimpleBrowser', 'problems', 'runTests', 'testFailure', 'think', 'todos', 'usages', 'edit', 'search', 'runCommands', 'runTasks', 'sequentialthinking', 'microsoft-docs']
mode: persistent
