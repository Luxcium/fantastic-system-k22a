...
export async function POST(request: NextRequest) {
  try {
    ...
    // Using 'medium' means the cache will be fresh for a moderate duration
    await revalidateTagWithLife(CacheTags.posts, "medium");
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    await revalidateTagWithLife(CacheTags.post(postId), "short");
